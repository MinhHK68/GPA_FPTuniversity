 ...
 *   ✔ Only non-asterisk (*) subjects (GPA subjects)
 *   ✔ Only STATUS === "Passed"
...
function doExportJSON() {
  ...
  const payload = {
    ...
    note: 'Only non-asterisk (*) and STATUS=Passed included',
...
<div class="note">⚠️ Only subjects with STATUS = Passed and no red asterisk (*) are included.</div>
<div class="cards">
